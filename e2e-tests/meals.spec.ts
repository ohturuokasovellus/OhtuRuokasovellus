...
const initTestDB = async () => {
    ...
    await sql`INSERT INTO meals (
        ...
        saturated_fat, energy, mass, vegetable_percent, price
        )
        VALUES 
        ('Kana bolognese', ${restaurantId}, '12345678',
        'Lorem ipsum dolor sit amet, consectetur adipiscing elit,
        sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',
        50, 'gluteeni, selleri', 1.3, 11.7, 8.2, 0.1, 0.1, 654.7, 1.9, 523, 50, 0, 1230),
        ('Pannacotta', ${restaurantId}, 'abcdefgh',
        'Ut enim ad minim veniam, quis nostrud exercitation ullamco
        laboris nisi ut aliquip ex ea commodo consequat.
        Duis aute irure dolor in reprehenderit in voluptate velit
        esse cillum dolore eu fugiat nulla pariatur.', 2,
        'maito, kananmuna', 27.4, 2.9, 16.3, 0, 27.4, 78.5, 10.9, 1119, 50, 0, 950)`
...
test.describe('restaurant meal page', () => {
    ...
    test('renders restaurant name, price and their images', async ({ page }) => {
    ...
    test('closes and opens meal cards correctly', async ({ page }) => {
        ...
        await page.locator('#kana-bolognese-button').click();
        await page.locator('#pannacotta-button').click();
        await expect(page.locator('text=Lorem ipsum dolor sit amet')).toBeHidden();
        await expect(page.locator('text=Ut enim ad minim veniam')).toBeHidden;
    });

    test('renders meal info correctly if selected', async ({ page }) => {
        await page.locator('#kana-bolognese-button').click();
        await expect(page.locator('text=CO2 EMISSIONS: 50')).toBeVisible();
        await expect(page.locator('text=ALLERGENS: gluteeni, selleri')).toBeVisible();
    ...
    test('renders nutritional values correctly', async ({ page }) => {
        ...
        await expect(page.locator('text=of which sugars:0.1 g')).toBeHidden();
