...
const initTestDB = async () => {
    ...
    await insertMeal('Kana bolognese', restaurantId, 'hyvä bolognese', 'Gluteeni', nutrientDictionary);
    await insertMeal('Pannacotta', restaurantId, 'hyvä pannacotta', 'Laktoosi, Maito', nutrientDictionary);
